...
KNOWN_DRUG_DATES = {
    ...
    'osimertinib': [
        ...
        {
            'date': '20240926',
            'indication_keywords': ['stage iii', 'iii期', 'unresectable', '不可切除', 'locally advanced', 'pacific', 'LAURA', 'chemoradiation'],
            'priority': 2,
            'description': 'Stage III unresectable EGFR+ NSCLC (LAURA trial)'
        },
        {
            'date': '20201218',
            'indication_keywords': ['adjuvant', 'resection', 'surgery', '术后辅助', 'tumor resection'],
            'priority': 3,
            'description': 'Adjuvant treatment post-resection'
        },
        {
            'date': '20180418',
            'indication_keywords': ['first-line', '1L', '一线', 'metastatic'],
            'priority': 4,
